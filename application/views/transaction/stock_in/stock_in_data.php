...
<section class="content-header">
	<h1>Stock In<small>Barang Masuk</small></h1>
	<ol class="breadcrumb">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="width: 200px;">
							...
							<a href="<?= site_url('stock/in/delete/'.$data->stock_id.'/'.$data->item_id) ?>" onclick="return confirm('Are you sure!')" class="btn btn-danger btn-xs">
